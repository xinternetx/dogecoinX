...
uint256 hashGenesisBlock("0xeed90476e1596a2638c792ea6ef579f2f27ce869e8205148296edbde78184465");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xeed90476e1596a2638c792ea6ef579f2f27ce869e8205148296edbde78184465");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Que es la vida un frenesi una ilusion una sombra una ficcion";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1397598012;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1621757;
        ...
        assert(block.hashMerkleRoot == uint256("0x6facd542346ce162bbe672ef00a144edc338561dd0a2e165e4eef90a17bee53b"));
